        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('home') }}" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('assets/svg/degidev2.svg') }}" class="h-8 mr-3" alt="degidev Logo" id="logo">
                    <!-- <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">degidev</span> -->
                </a>
            ...
            <div class="flex items-center">
                ...
                <button id="theme-toggle" type="button" class="flex items-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        // Verificar el tema guardado y aplicar el estado inicial
                        ...
                        // Mostrar el ícono correcto inicialmente
                        ...
                        if (logo) {
                            logo.src = document.documentElement.classList.contains('dark') ?
                                '{{ asset("assets/svg/degidev2.svg") }}' :
                                '{{ asset("assets/svg/degidev1.svg") }}';
                        }
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (sidebar && sidebarBackdrop && toggleSidebarMobileHamburger && toggleSidebarMobileClose) {
        ...
        document.getElementById('toggleSidebarMobile').addEventListener('click', toggleSidebarMobile);
        
        // Evento para el backdrop
        sidebarBackdrop.addEventListener('click', toggleSidebarMobile);

        // Evento para el botón de búsqueda móvil
        document.getElementById('toggleSidebarMobileSearch').addEventListener('click', toggleSidebarMobile);
      }
    });
  </script>